    ...
    <Box>
      ...
      <SimpleGrid columns={4} gap={"10"} mt={10}>
        <Box
          ...
          objectFit={"fill"}
        >
          <Image h={"100%"} w={"100%"} src="https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=772&q=80"></Image>
          <Text>Something</Text>
        </Box>
        <Box
          borderRadius={"xl"}
